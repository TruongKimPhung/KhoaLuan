							...
							<div class="product-info">
								...
								<div class="product-variants">
									<div class="produt-variants-size">
										<label>Dung lượng</label> <select class="nice-select">
										...
										<div class="single-product-wrap">
											...
											<div class="product_desc">
												<div class="product_desc_info">
													...
													<div class="comparesp">
														  <a
															href="http://localhost:8080/ecommerce/compare/${sanpham.getMasanpham() } ${value.getMasanpham() }  ${sanpham.getTensanpham() }vs ${value.getTensanpham() } ">So sánh chi tiết</a> 
