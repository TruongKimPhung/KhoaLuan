			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12 col-md-12 col-xs-12 col-lg-6 mb-30">
						<form id="form-doimatkhau" action="" >
							<div class=" form-group">
								<strong><span id="username">${ user.getUsername() }</span></strong><br />
								<br /> 
								<label for="password">Mật khẩu cũ</label> 
								<input type="password" name="password" id="password" class="form-control" />
								<span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span><br />
								<br><label for="newpassword">Mật khẩu mới</label> 
								...
								<p><button id="btnUpdateMatKhau" class="btn btn-primary">Update</button></p>
							</div>
						</form>
					</div>
				</div>
