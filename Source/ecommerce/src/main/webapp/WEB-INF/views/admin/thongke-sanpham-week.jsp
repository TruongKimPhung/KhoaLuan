            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Sản phẩm trong tuần</h6>
                </div>
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush" id="dataTable">
					...
					<tfoot>
                      ...
                      <tr>
                      	<th>
	                      <spring:url value="thongke-sanpham-week/?type=xls" var="xlsURL" />
							<spring:url value="thongke-sanpham-week/?type=pdf" var="pdfURL" />
