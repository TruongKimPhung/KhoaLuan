        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row mb-3">
                  ...
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="mt-2 mb-0 text-muted text-xs">
                        <span class="text-success mr-2"><i class="fa fa-arrow-up"></i> ${phantram}%</span>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Số lượng</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">${soluong }</div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                        <span class="text-success mr-2"><i class="fas fa-arrow-up"></i> ${phantram_soluong }%</span>
                        <span>Since last month</span>
                      </div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">${soluong_user }</div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                        <span class="text-success mr-2"><i class="fas fa-arrow-up"></i> ${phantram_user }%</span>
                        <span>Since last month</span>
                      </div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Turnover Of The Year</h6>
            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Quantity in year</h6>
                  <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                      aria-haspopup="true" aria-expanded="false">
                      <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                ...
                <div class="card-body">
                  <div class="chart-area">
                    <canvas id="myAreaChart_soluong"></canvas>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xl-12 col-lg-7" style="margin-bottom: 20px;">
