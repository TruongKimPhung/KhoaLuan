...
<head>
  ...
  <title>RuangAdmin - Thêm Danh Mục</title>
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="table-responsive p-3"> 
                  <form id="form-themdanhmuc" action="">
					<div class=" form-group">
						<label for="tendanhmuc">Tên danh mục</label><br /> 
						<input type="text" name="tendanhmuc" id="tendanhmuc" class="form-control" placeholder="tên danh mục" /><br />
						<label for="danhmuccha">Thuộc danh mục</label>
						<select
							name="madanhmuccha" class="form-control" id="madanhmuccha">
						...
						<button id = "btnThemDanhMuc" class="btn btn-primary">Thêm danh mục</button>
					</div>
				</form>
               </div>
              </div> 
